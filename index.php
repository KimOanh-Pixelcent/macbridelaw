...
function renderTemplate($templateName, $selectedTab, $subTitle, $pageType=''){
    Flight::render('partials/head', array('title' => " - $subTitle"), 'headContent');
    ...
    Flight::render($templateName, array('title' => " - $subTitle", 'subTitle' => $subTitle, 'pageType' => $pageType));
}
...
Flight::route('/about', function(){
    ...
    renderTemplate('template', 'about', ' - About Us', 'About Us', 'page-id-29');
});
